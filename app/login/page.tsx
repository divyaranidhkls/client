...
import { useRouter } from "next/navigation"; import { betterAuthClient } from "../lib/integration/better-auth";
const LoginPage = () => {
  ...
  const [error, setError] = useState<string | null>(null); const handleLogin = async () => {
    ...
    <div className="p-4 text-sm font-sans">
      {error && <p className="text-red-500 mb-2">{error}</p>}      {/* Login Section */}
      <div>
